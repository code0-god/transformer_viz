...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Product CSS | 78,696 B | 94,182 B | +15,486 B | 13,114 B | 14,701 B | +1,587 B |
| Eager app JS | 285,938 B | 290,650 B | +4,712 B | 74,675 B | 75,980 B | +1,305 B |
| Eager CSS + app JS | 364,634 B | 384,832 B | +20,198 B (+5.54%) | 87,789 B | 90,681 B | +2,892 B (+3.29%) |
...
Phase 1 adds 2,892 gzip bytes to the eager CSS + application JavaScript
