...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Product CSS | 78,696 B | 94,243 B | +15,547 B | 13,114 B | 14,712 B | +1,598 B |
| Eager app JS | 285,938 B | 290,650 B | +4,712 B | 74,675 B | 75,980 B | +1,305 B |
| Eager CSS + app JS | 364,634 B | 384,893 B | +20,259 B (+5.56%) | 87,789 B | 90,692 B | +2,903 B (+3.31%) |
| Lazy Score Matrix | 901,491 B | 901,491 B | 0 B | 234,815 B | 234,815 B | 0 B |
...
Phase 1 adds 2,903 gzip bytes to the eager CSS + application JavaScript
...
Figure geometry. Retirement removed 386 global lines without deleting
